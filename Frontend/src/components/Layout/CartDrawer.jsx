...
const CartDrawer = ({ drawerOpen, toggleCartDrawer }) => {
    ...
    return (
        <div
            className={`fixed top-0 bg-white right-0 w-3/4 sm:w-1/2 md:w-[30rem] h-full shadow-lg 
    flex flex-col transform transition-transform duration-300 z-50 ${drawerOpen ? "translate-x-0" : "translate-x-full"}`}>
